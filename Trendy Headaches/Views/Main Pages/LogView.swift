...
struct LogView: View {
    ...
    private func submitSymptomLog(){
        Task {
            ...
            //add log to database
            logID = await Database.shared.createLog(userID: userID,  date: enteredDate, symptom_onset: onset ?? "", symptom: sympID, severity: severity, med_taken: medTaken, med_taken_id: emergMedID, symptom_desc: sympDesc, notes: notes, submit: Date(), triggerIDs: triggIDs) ?? 0
